...
class Window(QtWidgets.QMainWindow):
    ...
    def create_widgets(self):
        ...
        self.button_46 = QtWidgets.QPushButton('选择模型进行高版本maya修复抖动')
    ...
    def create_layouts(self):
        ...
        h_Box_layout_12.addWidget(self.button_46)
    ...
    def create_connect(self):
        ...
        self.button_46.clicked.connect(self.new_maya_fix_jitter)  # 取消
    ...
    def new_maya_fix_jitter(self):
        ...
        if meshs:
            ...
            cmds.warning('请把生成的定位器p到总控制器最内圈。\n'
                         '如果有次级蒙皮导致了双倍偏移，请手动断开蒙皮的relativeSpaceMatrix属性')
        else:
            cmds.warning('未查询到mesh')
