...
import inspect
FilePath = 'E:\\code\\my_code\\IterativeVersion\\Maya_PY3_plug-in_2025\\ui'
sys.path.append(FilePath + '\\ZKM_plug_in_UI')
import ZKM_plug_in_Command
from ZKM_plug_in_Command import *
ZKM_plug_in_user_file_path = r'E:\code\my_code\IterativeVersion\Maya_PY3_plug-in_2025\user\self'
